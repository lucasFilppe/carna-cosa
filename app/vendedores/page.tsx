    ...
    <>
      ...
      <main className='mt-10'>
        ...
        >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-md sm:max-w-3xl mx-auto">
            {/* Card de vendedor */}
            ...
            {/* Card do próximo vendedor */}
            <div className="bg-black flex flex-col items-center p-4  rounded-lg min-h-[250px] min-h-[250px] w-full sm:w-[48%] ">
              <div className="relative w-full flex justify-center">
              <Image
                  src="/pedro.jpg"
